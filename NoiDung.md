...
Khi lực lượng sản xuất phát triển đến trình độ đầy đủ, chính nó lại trở thành nguyên nhân khách quan dẫn đến việc xóa bỏ chế độ chiếm hữu tư nhân về tư liệu sản xuất, từ đó xóa bỏ giai cấp và đấu tranh giai cấp.

Trong xã hội cộng sản nguyên thủy:

* Không có của cải dư thừa.
* Công cụ sản xuất lạc hậu (đá).
* Năng suất lao động thấp.
* Chế độ tư hữu chưa ra đời.
* Giai cấp chưa xuất hiện.

Cuối thời kỳ cộng sản nguyên thủy:

* Công cụ sản xuất phát triển (đồng).
* Năng suất lao động tăng.
* Xuất hiện của cải dư thừa.
* Chế độ tư hữu ra đời.
* Giai cấp xuất hiện.

Cơ sở lý luận để nghiên cứu giai cấp là **quan điểm duy vật lịch sử**.

#### Kết cấu giai cấp trong xã hội

* **Giai cấp cơ bản**: là giai cấp chính của xã hội, đại diện cho phương thức sản xuất thống trị.
* **Giai cấp không cơ bản**: đại diện cho phương thức sản xuất tàn dư hoặc mầm mống.
* **Tầng lớp trung gian**: không đại diện cho phương thức sản xuất nào.

Trong xã hội có đối kháng giai cấp còn tồn tại:
...
Trong xã hội có giai cấp, đấu tranh giai cấp là động lực trực tiếp và quan trọng của lịch sử; đồng thời vừa là biểu hiện, vừa là chìa khóa để giải quyết mâu thuẫn giữa lực lượng sản xuất và quan hệ sản xuất.
